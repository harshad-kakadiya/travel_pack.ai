...
export function Support() {
  return (
    <>
      <SEOHead
        title="Support"
        description="Get help with TravelBrief.ai. Find answers to common questions, contact our support team, and learn how to make the most of your travel briefs."
      />
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                How quickly will I receive my Travel Brief?
              </h3>
              <p className="text-gray-600">
                Most Travel Briefs are generated within 1-2 minutes after payment. 
            ...
            <div>
              ...
              <p className="text-gray-600">
                With our Yearly Unlimited plan, you can generate new Travel Briefs for updated trips. 
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Can I use Travel Brief offline?
              </h3>
              <p className="text-gray-600">
                Yes! Travel Briefs are delivered as PDF files that work completely offline. 
            ...
            <div>
              ...
              <p className="text-gray-600">
                We want you to be completely satisfied. If you're not happy with your Travel Brief, 
