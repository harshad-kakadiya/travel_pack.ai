      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {personaOrder.map((persona) => (
            <Reveal key={persona} as="section" className="mb-16" variant="fade-up">
              <Reveal className="flex items-center mb-8" variant="fade-right">
          ...
          <Reveal as="section" className="mb-16" variant="fade-up">
...
{/* NOTE: When rendering day headings inside examples, call renderDayTitle(startISO, index0) to keep date/day aligned. */}
