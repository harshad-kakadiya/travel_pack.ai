          ...
          <div class="container">
            ...
            <div class="footer">
              <div class="footer-content">
                <h3>💡 Generated by TravelBrief.ai AI Assistant</h3>
                <p>This travel brief was created using advanced AI technology based on your specific preferences and requirements.</p>
                <p class="brand">TravelBrief.ai - Premium Travel Planning</p>
              </div>
            </div>

            <!-- Timestamp -->
            <div class="timestamp">
              Generated on ${new Date().toLocaleString()} | TravelBrief.ai | support@travelbrief.ai
            </div>
          </div>
        </body>
        </html>
