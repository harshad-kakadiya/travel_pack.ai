          ...
          <div className="bg-white rounded-2xl shadow-sm p-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <ul className="list-disc pl-6 text-gray-600 mb-6">
                ...
                <li>No questions asked if you're not satisfied with the quality</li>
              ...
              <ul className="list-disc pl-6 text-gray-600 mb-6">
                ...
                <li>Prorated refund for unused portion of subscription</li>
              ...
              <p className="text-gray-600 mb-6">
                ...
                The exact timing depends on your payment method and financial institution.
              </p>
