...
import { BarChart3, Users, DollarSign, Globe, FileText, Plus, Edit, Trash2, LogOut } from 'lucide-react';
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      {blogPosts.length === 0 && (
                        <tr>
                          <td colSpan={4} className="px-6 py-4 text-center text-sm text-gray-500">No blog posts</td>
                        </tr>
                      )}
                    </tbody>
                  </table>
