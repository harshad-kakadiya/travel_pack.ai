  ...
  return (
    <section className="relative overflow-hidden rounded-3xl mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      <picture aria-hidden="true" className="absolute inset-0 block">
        <source type="image/webp" srcSet="/images/features-cta.webp" />
        <img src="/images/features-cta.jpg" alt="" className="w-full h-full object-cover" />
      </picture>
      ...
      <div className="relative z-10 text-center p-10 sm:p-12 md:p-16">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
          Ready to Create Your Perfect Travel Pack?
        </h2>
        <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
          Join thousands of travelers who trust Travel Pack for their adventures. Get started in minutes and travel with confidence.
        </p>
        <Link
          to="/plan"
